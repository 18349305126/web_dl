...
def SCFCN(nClasses, input_height, input_width,  decoder_filters=16, decoder_block_type='upsampling',
                       encoder_weights=None, input_tensor=None,activation='softmax', **kwargs):
    ...
    model = build_unet(backbone, nClasses, decoder_filters,
