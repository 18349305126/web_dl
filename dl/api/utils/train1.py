...
def train1(model_path, model_name, param_path):
    import sys
    sys.path.append(model_path)
    import importlib
    Net = importlib.import_module(model_name)  # 绝对导入
    # import UNet
    from Models import FCN8, FCN32, SegNet, SCFCN
    ...
    callbacks = [
        ...
        ModelCheckpoint(
            filepath=param_path.join('%s_model.hdf5' % key),
            verbose=True,
            save_best_only=True,
            monitor='loss',
            mode='min')
...
if __name__ == "__main__":
    ...
    model_name = 'UNet'
    param_path = 'E:/university/dasishang/bishe/code/WebDL-master10/WebDL-master/dl/api/utils/checkpoints/'
    train1(model_path, model_name, param_path)