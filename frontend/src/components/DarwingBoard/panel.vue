            ...
            <el-col :span="24">
                <div class="ef-tooltar">
                    ...
                    <div style="float: right;margin-right: 5px">
                        ...
                        <el-button type="info" plain round icon="el-icon-document" size="mini" @click="save">保存</el-button>
                        <el-button type="info" plain round icon="el-icon-document" size="mini" @click="run">运行</el-button>
                    </div>
                </div>
            </el-col>
        </el-row>
...
<script>
    ...
    // 使用修改后的jsplumb
    import './jsplumb'
    import { easyFlowMixin } from '@/components/DarwingBoard/mixins'
    import flowNode from '@/components/DarwingBoard/node'
    import nodeMenu from '@/components/DarwingBoard/node_menu'
    import FlowInfo from '@/components/DarwingBoard/info'
    import FlowHelp from '@/components/DarwingBoard/help'
    import FlowNodeForm from './node_form'
    import lodash from 'lodash'
    import { getData } from './data'
    import { ForceDirected } from './force-directed'

    import { execute } from '@/api/project'
    import { save } from '@/api/project'
    import { loadModel } from '@/api/project'
    ...
    export default {
        ...
        methods: {
            ...
            clickNode(nodeId) {
                ...
                switch(this.$refs.nodeForm.node.task){
                    case "dic":
                ...
                console.log(this.$refs.nodeForm.node)
            },
            // 是否具有该线
            hasLine(from, to) {
                for (var i = 0; i < this.data.lineList.length; i++) {
            ...
            save() {
                this.flowInfoVisible = true
                save(this.$refs.flowInfo._props.data).then(response => {
            ...
            run() {
                ...
                this.flowInfoVisible = true
                console.log("运行")
                execute(this.$refs.flowInfo._props.data).then(response => {
                  console.log(response.data)
                  this.taskExecuting = false
                }, response => {
                  console.log('error')
            ...
            load() {
                ...
                this.data.nodeList = []
                this.data.lineList = []
                this.data.model_id = this.$route.query.model_id
                this.data.model_name = this.$route.query.model_name
                this.data.project_id =101
